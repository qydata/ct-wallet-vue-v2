      ...
      <template v-slot:body>
        <div class="pb-14">
          ...
          <div class="mb-16 form-group text-3xl">
            ...
            <Amount :value="releaseFeeParsed" currency="CT" short sub/>
          </div>
          <div class="mb-16 form-group text-3xl">
            <label>You'll receive</label>
            <Amount :value="returnAmountParsed" currency="CT" short sub/>
          </div>
        </div>
      </template>
  ...
  validations() {
    return {
      ...
      confirmPhrase: [
        ...
        helpers.withParams(
          { phrase: this.phrase },
          validation.caseInsensitive(this.phrase, '确认短语不匹配。')
        )
      ]
    }
  },
