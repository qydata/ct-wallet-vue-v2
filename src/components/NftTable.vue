<template>
  <div class="transaction-table">
    <table>
      ...
      <tr v-if="sortable">
        <TableHeader width="10%" header="名称" :sortQuery="sortQuery"
                     sortParam="timestamp" :onSortingUpdate="updateSorting"
        />
        <TableHeader width="5%" header="符号" :sortQuery="sortQuery"
                     sortParam="hash" :onSortingUpdate="updateSorting"
        />
        <TableHeader width="5%" header="余额" :sortQuery="sortQuery"
                     sortParam="sortAddress" :onSortingUpdate="updateSorting"
        />
        <TableHeader width="10%" header="元数据" :sortQuery="sortQuery"
...
import NftTableItem from '@/components/NftTableItem'
