  ...
  <div>
    <Modal :close="cancel" :visible="visible && step === 1">
      <template v-slot:header>
        <h2 class="mb-8">提现 CT<span class="testnet-header" v-if="isTestnet">(Testnet)</span></h2>
          ...
          <div class="px-10 py-20 mb-32 text-center bg-black border border-gray-700 rounded convert-info md:text-left border-opacity-30 border-color">
            <div class="md:flex">
              <div class="left md:text-right md:w-1/2 md:flex md:pr-18 md:relative">
                ...
                <!-- eslint-disable-next-line max-len -->
                <span class="flex justify-center p-8 mx-auto mt-12 border border-gray-700 rounded-full md:ml-20 md:mt-0 md:flex-shrink-0 w-52 h-52 border-opacity-30 align-center">
              ...
              <div class="right md:w-1/2 md:flex md:pl-18">
                <!-- eslint-disable-next-line max-len -->
                <span class="flex justify-center  px-6 py-12  mx-auto mb-12 border rounded-full md:mb-0 md:flex-shrink-0 md:mr-20 w-52 h-52 align-center">
      ...
      <template v-slot:body>
        <div class="pb-12 min-h-300">
          <div class="form-group mb-14">
            ...
            <Amount :value="amount" currency="CT" sub/>
          </div>
          ...
          <div class="form-group mb-14">
            <label class="flex items-center space-x-3">
              手续费
              <Tooltip class="ml-3" position="right" theme="dark" :text="`Includes handling fee of ${minimumFee} CT`">
                <InformationCircleIcon class="hidden md:block button__icon w-15" />
              </Tooltip>
            </label>
            <Amount :value="fee" currency="CT" short sub/>
      ...
      <template v-slot:footer>
        <div class="px-24 py-32 border-t border-gray-700 border-opacity-30">
          ...
          <div class="grid grid-cols-1 gap-24 pt-12 md:grid-cols-2">
            ...
            <button class="w-full button button--success" :disabled="!canWithdraw" @click="withdraw">确认</button>
          </div>
        </div>
      </template>
    </Modal>
