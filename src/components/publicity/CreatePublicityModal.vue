      ...
      <template v-slot:body>
        <div class="pb-14">
          <div class="mb-16 form-group">
            ...
            <Amount :value="balance / 1e6" currency="CT" short sub/>
          </div>
          <div class="mb-16 form-group">
            ...
            <div class="flex justify-between mt-12 -mx-6 radio-list">
              ...
              <Radio
                ...
                id="gateway"
                extraName="Gateway"
                :label="`${shortGatewayStakeAmount} CT`"
              ...
              <Radio
                ...
                id="stargate"
                extraName="Stargate"
                :label="`${shortStargateStakeAmount} CT`"
          ...
          <div class="mb-16 form-group">
            ...
            <Amount v-if="canAffordStake" :value="remainingBalance" currency="CT" short sub/>
      ...
      <template v-slot:body>
        <div class="pb-14">
          ...
          <div class="form-group mb-25">
            ...
            <Amount :value="stakeAmountXe" currency="CT" short sub/>
          </div>
          <div class="mb-16 form-group">
            <label>Fee</label>
          ...
          <div class="mb-16 form-group">
            <label>Remaining Balance</label>
            <Amount :value="remainingBalance" currency="CT" short sub/>
          </div>
