<template>
  <div class="transaction-table">
    <table>
      ...
      <tr v-if="sortable">
        <TableHeader width="15%" header="日期" :sortQuery="sortQuery"
                     sortParam="timestamp" :onSortingUpdate="updateSorting"
        />
        <TableHeader width="30%" header="交易哈希" :sortQuery="sortQuery"
                     sortParam="hash" :onSortingUpdate="updateSorting"
        />
        <TableHeader width="30%" header="从/到" :sortQuery="sortQuery"
                     sortParam="sortAddress" :onSortingUpdate="updateSorting"
        />
<!--        <TableHeader width="30%" header="附加数据" :sortQuery="sortQuery"-->
<!--                     sortParam="data.memo" :onSortingUpdate="updateSorting"-->
<!--        />-->
        <TableHeader width="15%" header="状态" :sortQuery="sortQuery"
                     sortParam="block.height" :onSortingUpdate="updateSorting"
        />
        <TableHeader class="amount-col" width="10%" header="草田分数量" :sortQuery="sortQuery"
